...
{   
    ...
    private string $pass = '';
    private string $databaseName = 'gamingDB';
    ...
    function __construct() 
    {
        ...
        $this->cfg = parse_ini_file('gaming.ini', true); 
    ...
    function setupDatabase()
    {
        ...
        $this->createUser('test@test.com', 'BigPass1!', 2, 'Daniel', 'Hadlow');
        $this->createUser('test2@test2.com', 'BigPass1!', 3, 'Will', 'Price');
